<template>
  <div>
    ...
    <modal :mdShow="mdShowCart" @close="closeModal">
      ...
      <div slot="btnGroup">
        <a href="javascript:void(0)" class="btn btn-m" @click="delAddrSure">确认</a>
        <a href="javascript:void(0)" class="btn btn-m" @click="mdShowCart=false">关闭</a>
      </div>
    </modal>
    <modal :mdShow="mdShowAdd" @close="closeModal">
      ...
      <div slot="btnGroup">
        ...
        <a href="javascript:void(0)" class="btn btn-m" @click="mdShowAdd=false">关闭</a>
      </div>
    </modal>
